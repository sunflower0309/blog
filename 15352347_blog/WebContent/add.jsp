...
StringBuilder table=new StringBuilder("");
	...
	if(request.getParameter("save")!=null) {
		try{
			...
			stmt.executeUpdate(String.format("insert into article(article_author,article_title,article,create_time) values('%s','%s','%s','%s')",username,title,article,time));	
			stmt.close();
			con.close();
...
<form action="add.jsp" method="post">
	...
	标题:<input type="text" name="title" size = 80 value="<%=title%>"><br><br>
	<textarea rows="50" cols="50" name="article" placeholder="写入内容..."></textarea><br><br>
