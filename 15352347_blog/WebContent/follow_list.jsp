...
if(username.equals("")){
	...
	String fmt="select followed_author from follow where follower='%s'";
	String str=String.format(fmt,username);
	ResultSet rs=null;
	rs=stmt.executeQuery(str);
	table.append("<table><tr><th>关注对象</th></tr>");
	while(rs.next()) {
		
	    table.append(String.format(
	   		 "<tr><td><a href='mainpage.jsp?pauthor="+rs.getString("followed_author")+"'>%s</a></td><td><a href='check3.jsp?pauthor="+rs.getString("followed_author")+"'>取消关注</a></td></tr>",
	   		 rs.getString("followed_author")
